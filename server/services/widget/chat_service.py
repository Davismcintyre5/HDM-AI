# ====================================================================================================
# 40. server/services/widget/chat_service.py
# ====================================================================================================
...
class WidgetChatService:
    ...
    async def chat(self, source: str, message: str, conversation_id: Optional[str] = None, user_id: Optional[str] = None, context: Optional[dict] = None) -> Dict[str, Any]:
        conversation = None
        ...
        system_prompts = {"docusoft": "You are DocuSoft AI. Help with documents, pricing, and purchases.", "hdm_portfolio": "You are HDM Portfolio AI. Answer questions about our company, services, apps, and projects."}
        ...
        result = await ai_service.groq_chat(messages, max_tokens=800, service="widget")
