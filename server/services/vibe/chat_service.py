# ====================================================================================================
# 24. server/services/vibe/chat_service.py
# ====================================================================================================
...
class VibeChatService:
    ...
    async def chat_message(self, user_id: str, message: str, conversation_id: str = None, data: dict = None) -> Dict[str, Any]:
        ...
        result = await ai_service.groq_chat([{"role": "system", "content": "You are Vibe Social AI. Help with social media and content." + context}, {"role": "user", "content": message}], max_tokens=800, service="vibe")
    ...
    async def assistant(self, user_id: str, task: str, context: dict = None, data: dict = None) -> Dict[str, Any]:
        ...
        result = await ai_service.groq_chat([{"role": "user", "content": prompt}], max_tokens=800, service="vibe")
    ...
    async def creative(self, user_id: str, prompt: str, style: str = None, data: dict = None) -> Dict[str, Any]:
        ...
        result = await ai_service.groq_chat([{"role": "user", "content": full_prompt}], max_tokens=1000, service="vibe")
