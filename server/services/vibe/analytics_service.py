# ====================================================================================================
# 29. server/services/vibe/analytics_service.py
# ====================================================================================================
...
class VibeAnalyticsService:
    ...
    async def churn_prediction(self, user_id: str, activity_data: dict = None, data: dict = None) -> Dict[str, Any]:
        result = await ai_service.groq_chat([{"role": "user", "content": f"Predict churn risk for {user_id}. Return JSON: {{\"risk_score\": 0.0-1.0}}"}], max_tokens=200, service="vibe")
    ...
    async def growth_projections(self, user_id: str, metrics: dict = None, data: dict = None) -> Dict[str, Any]:
        result = await ai_service.groq_chat([{"role": "user", "content": "Generate growth projections. Return JSON: {\"projections\": {}}"}], max_tokens=300, service="vibe")
