# ====================================================================================================
# 26. server/services/vibe/feed_service.py
# ====================================================================================================
...
class VibeFeedService:
    ...
    async def personalize_feed(self, user_id: str, interests: List[str] = None, data: dict = None) -> Dict[str, Any]:
        ...
        result = await ai_service.groq_chat([{"role": "user", "content": prompt}], max_tokens=500, service="vibe")
    ...
    async def recommend_users(self, user_id: str, limit: int = 10, data: dict = None) -> Dict[str, Any]:
        result = await ai_service.groq_chat([{"role": "user", "content": f"Recommend {limit} users. Return JSON: {{\"users\": []}}"}], max_tokens=300, service="vibe")
    ...
    async def recommend_content(self, user_id: str, limit: int = 20, data: dict = None) -> Dict[str, Any]:
        result = await ai_service.groq_chat([{"role": "user", "content": f"Recommend {limit} content items. Return JSON: {{\"content\": []}}"}], max_tokens=500, service="vibe")
