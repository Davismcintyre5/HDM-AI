# ====================================================================================================
# 10. server/services/smartpos/insights_service.py
# ====================================================================================================
...
class InsightsService:
    async def get_insights(self, business_id: str, insight_type: str, data: dict = None) -> Dict[str, Any]:
        ...
        if "tax_rate" in data: parts.append(f"Tax Rate: {data['tax_rate']}%")
        ...
        parts.append("⚠️ Use specific numbers from the data. Do not make up data.")
