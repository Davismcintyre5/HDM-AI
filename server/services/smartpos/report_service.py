# ====================================================================================================
# 14. server/services/smartpos/report_service.py
# ====================================================================================================
...
Format as a professional business report with sections: Overview, Key Metrics, Details, Recommendations."""
        result = await ai_service.groq_chat([{"role": "user", "content": prompt}], temperature=0.4, max_tokens=1500, service="smartpos")
