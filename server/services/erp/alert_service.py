# ====================================================================================================
# 6. server/services/erp/alert_service.py
# ====================================================================================================
...
- Use real names and numbers""")
        ...
        prompt = "\n".join(parts)
        result = await ai_service.groq_chat([{"role": "user", "content": prompt}], temperature=0.1, max_tokens=500, service="erp")
        ...
        try:
            ...
            for a in alerts:
                await AlertSchedule(tenant_id=tenant_id, alert_type=a.get("type", "unknown"), message=a.get("message", ""), severity=a.get("severity", "low")).insert()
