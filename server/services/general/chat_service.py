...
# ====================================================================================================
"""
HDM AI - Chat Service with file upload, search toggle, deep think, external data, multi-provider, custom system prompt
"""
...
class ChatService:
    ...
    async def chat(
        ...
        """Main chat handler with all features including custom system prompt."""
        ...
        # Use custom system prompt if provided, otherwise build dynamic one
        if system_prompt:
...
"""
        result = await ai_service.groq_chat(
            ...
            temperature=0.1, max_tokens=300, service="general",
        )
        try:
    ...
    async def _generate_suggestions(self, user_msg: str, ai_reply: str, user_keys: list = None) -> List[str]:
        try:
            ...
            result = await ai_service.groq_chat(
                ...
                temperature=0.8, max_tokens=100, service="general",
            )
