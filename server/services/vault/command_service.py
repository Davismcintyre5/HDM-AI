# ====================================================================================================
# 38. server/services/vault/command_service.py
# ====================================================================================================
...
Return JSON: {{"intent": "...", "success": true/false, "result": "what to tell the user"}}"""
        result = await ai_service.groq_chat([{"role": "user", "content": prompt}], temperature=0.1, max_tokens=300, service="vault")
        try: return json.loads(result.get("reply", "{}"))
        except: return {"intent": "", "success": False, "result": "Could not understand command."}
