# ====================================================================================================
# 21. server/services/spark/group_service.py
# ====================================================================================================
...
class GroupService:
    ...
    async def mention_suggest(self, partial_name: str, group_members: List[str], data: dict = None) -> Dict[str, Any]:
        result = await ai_service.groq_chat([{"role": "user", "content": f"Suggest members matching '{partial_name}' from: {group_members}. Return JSON: {{\"suggestions\": []}}"}], max_tokens=100, service="spark")
