# ====================================================================================================
# 9. server/services/spark/smart_reply_service.py
# ====================================================================================================
...
class SmartReplyService:
    ...
    async def quick_reply(self, message: str, count: int = 4, data: dict = None) -> Dict[str, Any]:
        result = await ai_service.groq_chat([{"role": "user", "content": f"Generate {count} very short replies (1-3 words) to: '{message}'. One per line."}], max_tokens=80)
