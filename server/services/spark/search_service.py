# ====================================================================================================
# server/services/spark/search_service.py
# ====================================================================================================
...
class SparkSearchService:
    async def semantic_search(self, query: str, documents: List[dict] = None, limit: int = 10) -> Dict[str, Any]:
    ...
    async def message_search(self, query: str, user_id: str, limit: int = 20) -> Dict[str, Any]:
    ...
    async def contact_search(self, query: str, user_id: str, limit: int = 10) -> Dict[str, Any]:
        result = await ai_service.groq_chat([{"role": "user", "content": f"Search contacts for '{query}'. Return JSON: {{\"contacts\": []}}"}], max_tokens=200)
